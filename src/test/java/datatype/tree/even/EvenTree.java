...
/**
 * Description:
 * You are given a datatype.tree (a simple connected graph with no cycles).
 * You have to remove as many edges from the datatype.tree as possible to obtain a forest with the condition that :
 *  Each connected component of the forest should contain an even number of vertices.
 * To accomplish this, you will remove some edges from the datatype.tree. Find out the number of removed edges.
 * 
 * Challenge:
