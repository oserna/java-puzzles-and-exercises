...
public class TreeUtils {
	...
	/**
	 * Each row in the matrix define a relationship between a father (first column) and one of its children (second column).
	 * 
	 * Matrix example:
	 *  
	 *	[ 2 , 4 ] -> [parent, child]
     ...
     *	[ 2 , 5 ]
     *
	 * The matrix above define this binary tree:
 	 *
     *            1
     *         2      3
     *       4   5  6
	...
	/**
	 * Each matrix row is a pair of siblings in the tree.
	 *   
	 * Matrix example:
	 * 
